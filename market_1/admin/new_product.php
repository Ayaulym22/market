        ...
        <div class="col-md-12 col-md-offset-3">
          ...
          <form id="upload-image" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" name="p_price" required>
            </div>
             <div class="form-group">
              <label for="image">Product Quantity:</label>
              <input class="form-control" type="text" name="p_quant" required>
            </div>
            <div class="form-group">
              <label for="image">Product Category:</label>
              <select class="form-control" name="p_cat" id="" required>
                <?php 

                  $selCat = "SELECT * FROM category";
                  $startSel = $con->query($selCat);
            ...
            <div class="form-group">
              <label for="image" style="border: solid 1px black !important; padding: 5px;">Product Image</label>
...
<script>
  ...
  $('#upload-image').on('submit',(function(e) {
    ...
    $.ajax({
      ...
      url: '../endpoints/new_product.php', // Скрипт обработчика
